...
def main(args):
    ...
    microgrid_env.final_step = 11680
    ...
    microgrid_env.initial_step = 11680
    microgrid_env.final_step = 23360
    ...
    microgrid_env.initial_step = 23360
    microgrid_env.final_step = 35040
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dqn_episodes', type=int, default=40, help='Number of episodes for DQN training.')
